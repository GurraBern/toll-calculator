...
[TestFixture]
public class HolidayProviderOldTests
{
    private static readonly IHolidayProvider ProviderOld = new HolidayProviderOld();

    public static IEnumerable<DateTime> HolidayDates2013()
    {
        // January
    ...
    {
        Assert.That(ProviderOld.IsHoliday(date), Is.True);
    } 
}